...
│       ├── script.py.mako             ✅
│       └── versions/                  ✅  0001 schema; 0002 classification_type / edge-json; 0003 trip file_size_bytes; 0004 health_config; 0005 clip.public_visible; 0006 flag_def / clip_flag; 0007 hide synthetic clips; 0008 hide clips without real_world; 0009 error flag_def; 0010 buzzer play_on_safe; 0011 testing flag_def
│
...
│   │   └── test_migrations.py         ✅  Alembic upgrade head + seed; 0008 hides non-real_world; 0009 seeds error; 0011 seeds testing
│   │
│   ├── backend/
