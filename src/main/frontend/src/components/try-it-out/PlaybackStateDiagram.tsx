...
export function playbackAccentClass(stateId: string): string | undefined {
  if (stateId === 'CompleteStop') {
    return 'border-emerald-600 shadow-[0_0_32px_8px_rgb(5_150_105/0.85)]'
  }
  if (stateId === 'RollingStop') {
    return 'border-violet-600 shadow-[0_0_32px_8px_rgb(124_58_237/0.85)]'
  }
  if (stateId === 'RunThrough') {
    return 'border-red-600 shadow-[0_0_32px_8px_rgb(220_38_38/0.85)]'
  }
  return undefined
}
...
function nodeClass(
  ...
  const live =
    tone === 'green'
      ? 'border-emerald-600 bg-emerald-950 text-emerald-50 shadow-[0_0_28px_6px_rgb(5_150_105/0.85)]'
      : tone === 'purple'
        ? 'border-violet-600 bg-violet-950 text-violet-50 shadow-[0_0_28px_6px_rgb(124_58_237/0.85)]'
        : tone === 'red'
          ? 'border-red-600 bg-red-950 text-red-50 shadow-[0_0_28px_6px_rgb(220_38_38/0.85)]'
